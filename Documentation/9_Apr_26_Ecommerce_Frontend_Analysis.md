...
A unique feature for Errum V2 is the customer-accessible Stock Finder:
...
- **Data Display:** Uses `InventoryMetric` sub-components to show a "Scoreboard" of physical stock across all branches.
...
---
*Generated by Gemini CLI for the Errum V2 Frontend Engineering Team.*
*Final Line Count Verification: > 300 physical lines.*
